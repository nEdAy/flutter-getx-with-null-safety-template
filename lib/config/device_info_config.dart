...
class DeviceInfoConfig {
  ...
  static late final DeviceInfoConfig _instance;
  ...
  }) => DeviceInfoConfig._internal(androidInfo, iosInfo);
  ...
  static String deviceModel() {
    ...
    if (isAndroid) {
      return _instance.androidInfo?.model ?? '';
    } else {
      return _instance.iosInfo?.utsname.machine ?? '';
    }
  }
  ...
  static String deviceManufacturer() {
    var isAndroid = Platform.isAndroid;
    if (isAndroid) {
      return _instance.androidInfo?.manufacturer ?? '';
    } else {
      return 'Apple';
    }
  }
  ...
  static String deviceSystemVersion() {
    var isAndroid = Platform.isAndroid;
    if (isAndroid) {
      return _instance.androidInfo?.version.release ?? '';
    } else {
      return 'iOS ${_instance.iosInfo?.systemVersion}';
    }
  }
  ...
  static Map<String, dynamic> deviceInfoMap() {
    ...
    try {
      if (Platform.isAndroid) {
        deviceInfo = _readAndroidBuildData(_instance.androidInfo);
      } else if (Platform.isIOS) {
        deviceInfo = _readIosDeviceInfo(_instance.iosInfo);
      }
